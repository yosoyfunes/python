...
class ExamplePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.quote = wx.StaticText(self, label="Un label de texto estatico", pos=(20, 30))
        ...
        self.sampleList = ['Aburrido', 'Bueno', 'Lo mejor', 'Alucinante']
        self.lblhear = wx.StaticText(self, label="Que te parece el programa :", pos=(20, 90))
        ...
        rb = wx.RadioBox(self, label="¿Cual es tu color favorito?", pos=(20, 210), choices=radioList,  majorDimension=3,
